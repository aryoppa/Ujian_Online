    ...
    public function print_all()
		{
				...
				$query = $this->db->query("
						...
						JOIN 
								tb_siswa si ON p.id_siswa = si.id_siswa
						" . (isset($id) ? "WHERE j.id_peserta = $id" : "") . "
				");
				...
				foreach ($results as $row) {
						$data['cetak'][$row['nama_siswa']][] = $row;
				}

				$this->mypdf->generate('admin/v_printall', $data, 'Cetak Hasil Ujian', 'A4', 'Landscape');
		}
